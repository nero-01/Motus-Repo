...
export const ENV = {
  ...
  // Google Cloud Vision API – OCR for weekly planner (set EXPO_PUBLIC_GOOGLE_VISION_API_KEY)
  ...
  // Testing Configuration - Disable mock mode for production
  FORCE_MOCK: process.env.EXPO_PUBLIC_FORCE_MOCK === 'true' || false, // Disable mock mode by default
};
